<template>
  <div class="v-container v-locale--is-ltr">
    <h1 class="mb-6 pa-4 text-center">Foire Aux Questions (FAQ)</h1>
    ...
    <v-expansion-panels variant="accordion">
      <v-expansion-panel
        ...
        :title="q.question"
      >
        <!-- Alors, il est possible aussi de faire de cette manière
        Mais il est plus simple de faire comme ci-dessus-->
